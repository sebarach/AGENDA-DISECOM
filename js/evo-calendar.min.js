    ...
    ((t = (function () {
        ...
        (t.prototype.buildTheBones = function () {
            ...
            if ((t.calculateDays(), !t.$elements.calendarEl.html())) {
                ...
                (a += "</tr></table></div>"),
                    (a += '<div class="calendar-events"><i class="far fa-calendar-plus agregarEvento"></i>Agregar Evento <div class="event-header"><p></p></div><div class="event-list"></div></div>'),
